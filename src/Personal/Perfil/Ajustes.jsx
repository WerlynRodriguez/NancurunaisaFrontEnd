...
import { Layout, Typography,Avatar, Menu, Dropdown, PageHeader, Button, Collapse, Checkbox, message, Skeleton } from 'antd';
import Logout from "../../Components/LogOutButton"
import "../../Utils/TextUtils.css"
import { DatabaseFilled, FormatPainterFilled, NotificationFilled, QuestionCircleFilled, ReadFilled, SmileFilled, SnippetsFilled } from '@ant-design/icons';
...
export default function Ajustes(){
    ...
    const getData = () => {
        ...
        getById("usuarios","idUsuario",id,item).then((response) => {
            ...
            let auxItems = [];
            auxItems.push(getItem("Notificaciones", "opNot",<NotificationFilled/>,[
                getItem("Permitir Notificaciones", "opNotPer",<QuestionCircleFilled/>)
            ]));

            if (aux.idRol.idRol === 1){
                auxItems.push(getItem('Administrar', 'opAdm', <DatabaseFilled />, [
    ...
    return(
        <Layout>
            ...
            className='ContentLayout'>
                ...
                <div 
                style={{display:"flex",flexDirection:"column", borderRadius:"25px", paddingBottom:"20px",
                maxWidth:600,width:"100%",backgroundColor:"white"}}>
                    ...
                    <>
                        ...
                        active
                        shape="square"
                        style={{display:loading?"":"none",margin:"10px 0px",width:"100%",
                        minHeight: "120px",boxSizing:"content-box"}}/>
                        <Skeleton.Button
                        active
                        shape="round"
                        style={{display:loading?"":"none",margin:"10px 10px",width:"auto",
                        minHeight: "20px"}}/>
                    </>
                    :
                    <>
                        ...
                        paddingTop:15,paddingBottom:15}}>
                            ...
                            justifyContent:"center",width:"80%",marginLeft:25}}>
