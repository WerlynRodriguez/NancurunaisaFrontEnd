...
import { Layout, Typography,Avatar, Menu, Dropdown, PageHeader, Button, Collapse, Checkbox, message } from 'antd';
        ...
        <Layout>
            ...
            className='ContentLayout'>
                ...
                maxWidth:600,width:"100%",backgroundColor:"white"}}>
                    ...
                    checked={IHBB} 
                    onChange={(e)=>{
                        setIHBB(e.target.checked); 
                        localStorage.setItem('Interfaz_HideBottomBar', e.target.checked);
                    }}>
                        Ocultar siempre Barra de Navegación
                    </Checkbox>
                </div>
